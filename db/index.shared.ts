...
function initializeExpoSqliteDb() {
  ...
  const createStatements = [
    ...
    `CREATE TABLE IF NOT EXISTS pitdata2026 (
      ...
      robot_weight INTEGER DEFAULT 0,
      drivetrain TEXT NOT NULL DEFAULT 'TANK' CHECK (drivetrain IN ('TANK', 'SWERVE', 'MECANUM', 'H-DRIVE', 'OTHER')),
      driveteam TEXT NOT NULL DEFAULT '',
      hopper_capacity INTEGER NOT NULL DEFAULT 0,
      pickup_ground INTEGER NOT NULL DEFAULT 0,
      pickup_feeder INTEGER NOT NULL DEFAULT 0,
      trench_bot INTEGER NOT NULL DEFAULT 0,
      bump_bot INTEGER NOT NULL DEFAULT 0,
      start_position_trench_left INTEGER NOT NULL DEFAULT 0,
      start_position_bump_left INTEGER NOT NULL DEFAULT 0,
      start_position_center INTEGER NOT NULL DEFAULT 0,
      start_position_bump_right INTEGER NOT NULL DEFAULT 0,
      start_position_trench_right INTEGER NOT NULL DEFAULT 0,
      auto_pickup_corral INTEGER NOT NULL DEFAULT 0,
      auto_pickup_outpost INTEGER NOT NULL DEFAULT 0,
      auto_fuel INTEGER NOT NULL DEFAULT 0,
      auto_fuel_count INTEGER NOT NULL DEFAULT 0,
      auto_pass INTEGER NOT NULL DEFAULT 0,
      auto_pass_count INTEGER NOT NULL DEFAULT 0,
      auto_climb INTEGER NOT NULL DEFAULT 0,
      auto_notes TEXT NOT NULL DEFAULT '',
      tele_fuel INTEGER NOT NULL DEFAULT 0,
      tele_pass INTEGER NOT NULL DEFAULT 0,
      tele_notes TEXT NOT NULL DEFAULT '',
    ...
    `CREATE TABLE IF NOT EXISTS already_robot_photos (
      event_key TEXT NOT NULL,
      team_number INTEGER NOT NULL,
      image_id TEXT NOT NULL,
      image_url TEXT,
      description TEXT,
      PRIMARY KEY (event_key, team_number, image_id),
      FOREIGN KEY (event_key) REFERENCES frcevent(event_key),
      FOREIGN KEY (team_number) REFERENCES teamrecord(team_number)
    );`,
